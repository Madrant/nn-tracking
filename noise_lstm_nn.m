function [net_outputs, train_samples] = noise_lstm_nn(t, x, xn_train, xn_test, sample_length, result_length, predict_offset, samples_div, hiddenSizes, maxEpochs, hiddenType, snr_array)
    % Print options
